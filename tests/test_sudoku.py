...
def test_update_candidate_answers_exhaustive_combination_add_one_to_last_element():
    candidate_answers = np.array([1,1,1,1,5])
    expected_answers = np.array([1,1,1,1,6])
    updated_answers = update_candidate_answers_exhaustive_combination(
        candidate_answers)
    assert (updated_answers == expected_answers).all()

def test_update_candidate_answers_exhaustive_combination_last_element_is_9():
...
def test_update_candidate_answers_exhaustive_combination_last_two_elements_are_9():
...
def test_update_candidate_answers_exhaustive_combination_last_all_elements_are_9():
